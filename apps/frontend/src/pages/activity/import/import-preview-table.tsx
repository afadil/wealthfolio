...
export const ImportPreviewTable = ({
  ...
  const filters = useMemo(
    () =>
      [
        {
          id: "isValid",
          title: t("activity.import.preview.filter_status"),
          options: [
            { label: t("activity.import.preview.filter_error"), value: "false" },
            { label: t("activity.import.preview.filter_valid"), value: "true" },
          ],
        },
        {
          id: "activityType",
          title: t("activity.import.preview.filter_type"),
  ...
  const columns = useMemo(
    () => getColumns(accounts, baseCurrency, t),
                  ...
                  <TableCell colSpan={table.getAllColumns().length} className="h-24 text-center">
                    <div className="flex flex-col items-center justify-center space-y-2 py-8">
                      ...
                      <p className="text-muted-foreground text-sm">
                        {t("activity.import.preview.empty_no_activities")}
                      </p>
                    </div>
                  </TableCell>
                </TableRow>
...
function getColumns(
  ...
  return [
    ...
    },
    {
      id: "isValid",
      accessorKey: "isValid",
      header: () => <span className="sr-only">{t("activity.import.preview.sr_status")}</span>,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      accessorKey: "account",
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t("activity.import.preview.col_account")} />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      accessorKey: "date",
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t("activity.import.preview.col_date")} />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t("activity.import.preview.col_type")} />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      accessorKey: "symbol",
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t("activity.import.preview.col_symbol")} />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          ...
          column={column}
          title={t("activity.import.preview.col_shares")}
        />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          className="justify-end text-right"
          column={column}
          title={t("activity.import.preview.col_price")}
        />
      ),
      cell: ({ row }) => {
        const activityType = row.getValue("activityType");
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          className="justify-end text-right"
          column={column}
          title={t("activity.import.preview.col_amount")}
        />
      ),
      cell: ({ row }) => {
        const activityType = row.getValue("activityType");
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          className="justify-end text-right"
          column={column}
          title={t("activity.import.preview.col_fee")}
        />
      ),
      cell: ({ row }) => {
        const activityType = row.getValue("activityType");
...

    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader column={column} title={t("activity.import.preview.col_currency")} />
      ),
      cell: ({ row }) => {
