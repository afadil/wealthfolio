...
pub fn router() -> Router<Arc<AppState>> {
    Router::new()
        ...
        .route("/valuations/history", get(handlers::get_historical_valuations))
        .route("/valuations/latest", get(handlers::get_latest_valuations))
        .route("/allocations", get(handlers::get_portfolio_allocations))
        .route("/allocations/holdings", get(handlers::get_holdings_by_allocation))
        .route(
            "/snapshots",
        ...
        .route("/snapshots/import", post(handlers::import_holdings_csv_handler))
}
