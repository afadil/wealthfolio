...
export const Icons = {
  ...
  Income2: ({ ...props }: LucideProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 14 14"
      id="Coin-Share--Streamline-Flex"
      height={14}
      width={14}
      {...props}
    >
      ...
      <g id="coin-share--payment-cash-money-finance-receive-give-coin-hand">
        <path
          id="Vector"
          fill="#ffffff"
          d="M10.3296 6.83547c2.0274 0 3.1677 -1.14038 3.1677 -3.16773S12.357 0.5 10.3296 0.5C8.30225 0.5 7.16187 1.64039 7.16187 3.66774c0 2.02735 1.14038 3.16773 3.16773 3.16773Z"
          strokeWidth={1}
        />
        <path
          id="Vector_2"
        ...
        <path
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          d="m10.3296 3.05457 0 1.22615"
          strokeWidth={1}
        />
        <path
          id="Vector 2052"
          fill="#d8d6d4"
          d="M7.27651 10.2517 3.3389 9.54557l1.11679 0.19954c0.7641 0.13653 1.48309 -0.40523 1.56252 -1.17736 0.06785 -0.65959 -0.35877 -1.26898 -1.00176 -1.43092L3.81289 6.8337c-0.78644 -0.19808 -1.59843 -0.27541 -2.40812 -0.22936L0.5 6.6558v5.2455l3.38239 1.1975c1.61473 0.5716 3.38306 0.5313 4.97002 -0.1135l3.26239 -1.3255c0.5835 -0.2371 0.8997 -0.871 0.7382 -1.4798 -0.1739 -0.65536 -0.8382 -1.05289 -1.498 -0.89631l-4.07849 0.96801Z"
          strokeWidth={1}
        />
        <path
          id="Vector 111"
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          d="m0.671814 6.65582 0.712946 -0.04411c0.82279 -0.05091 1.64851 0.02566 2.44791 0.22699l1.18378 0.29815c0.64299 0.16194 1.06961 0.77134 1.00176 1.43092 -0.07943 0.77213 -0.79842 1.31389 -1.56252 1.17737L3.3389 9.5456l3.93761 0.7061 4.07849 -0.96799c0.6598 -0.15658 1.3241 0.24095 1.498 0.89629 0.1615 0.6088 -0.1547 1.2427 -0.7382 1.4798l-3.26239 1.3255c-1.58696 0.6448 -3.35529 0.6852 -4.97002 0.1135L0.5 11.9013"
          strokeWidth={1}
        />
      </g>
    </svg>
  ...
  Income: ({ ...props }: LucideProps) => (
    <svg
      ...
      fill="none"
      viewBox="0 0 14 14"
      id="Dollar-Increase--Streamline-Flex"
      height={14}
      width={14}
      {...props}
    >
      ...
      <g id="dollar-increase--dollar-increase-arrow-up-fluctuate-investment">
        <path
          id="Vector"
          fill="#d8d6d4"
          d="M5.414 10.04c3.087 0 4.823 -1.737 4.823 -4.824 0 -3.087 -1.736 -4.823 -4.823 -4.823C2.327 0.393 0.591 2.13 0.591 5.216c0 3.087 1.736 4.824 4.823 4.824Z"
          strokeWidth={1}
        />
        <path
          id="Vector_2"
        ...
        <path
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M6.808 4.249c0 -0.547 -0.45 -1.012 -1.394 -1.012 -0.945 0 -1.394 0.438 -1.394 1.012 0 0.447 0.45 0.877 1.394 1.012 0.945 0.135 1.607 0.446 1.607 1.12 0 0.608 -0.662 1.117 -1.607 1.117s-1.607 -0.434 -1.607 -1.012"
          strokeWidth={1}
        />
        <path
          id="Vector_4"
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M10.09 6.794c0.094 -0.437 0.142 -0.913 0.142 -1.426 0 -3.087 -1.736 -4.824 -4.823 -4.824C2.322 0.544 0.585 2.281 0.585 5.368c0 2.336 0.995 3.898 2.817 4.52"
          strokeWidth={1}
        />
        <path
          id="Vector 3175"
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M4.027 13.456s2.359 -3.117 3.405 -3.032c0.84 0.068 0.915 1.854 1.694 1.532 0.52 -0.215 3.484 -2.904 4.213 -3.57"
          strokeWidth={1}
        />
        <path
          id="Vector_5"
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M10.846 8.163c0.776 -0.194 1.784 -0.116 2.52 0.195 0.194 0.775 0.116 1.783 -0.194 2.52"
          strokeWidth={1}
        />
      </g>
    </svg>
