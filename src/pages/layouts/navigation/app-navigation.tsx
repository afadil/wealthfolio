...
const staticNavigation: NavigationProps = {
  primary: [
    ...
    },
    {
      ...
      title: "Spending",
      href: "/spending",
      keywords: ["expenses", "spending", "costs", "payments", "bills"],
      label: "View Spending",
    },
    {
      ...
      href: "/activities",
      keywords: ["trades", "buy", "sell", "dividends", "investments", "portfolio"],
      label: "View Investment Activity",
    },
    {
      icon: <Icons.Wallet className="size-6" />,
      title: "Cashflow Activity",
      href: "/cash/activities",
      keywords: ["cashflow", "spending", "transactions", "deposits", "withdrawals", "expenses"],
      label: "View Cashflow Activity",
    },
  ],
  secondary: [
    {
