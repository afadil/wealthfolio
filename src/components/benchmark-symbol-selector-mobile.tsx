  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <Button
          variant="outline"
          aria-label={iconOnly ? t("add_benchmark") : undefined}
          className={cn(
        ...
        <div className="flex h-[calc(85vh-5rem)] flex-col">
          ...
          <div className="border-border border-b px-6 py-3">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder={t("search_benchmarks", { ns: "common" })}
                value={searchQuery}
          ...
          <ScrollArea className="flex-1 px-6 py-4">
            ...
            {isLoading && searchQuery.length > 2 && (
              <div className="space-y-2">
                <div className="text-muted-foreground mb-3 text-sm font-medium">{t("searching", { ns: "common" })}</div>
            ...
            {searchQuery.length > 0 &&
              ...
              BENCHMARKS.every(
                ...
                <div className="text-muted-foreground flex h-full items-center justify-center text-sm">
                  {t("no_benchmarks_found", { ns: "common" })}
                </div>
              )}
          </ScrollArea>
        </div>
