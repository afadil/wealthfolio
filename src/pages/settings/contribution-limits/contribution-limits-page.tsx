  ...
  return (
    <>
      <div className="space-y-6">
        <SettingsHeader heading={t("limits_full_title")} text={t("limits_description")}>
          <>
            <Button
              size="icon"
              className="sm:hidden"
              onClick={() => handleAddLimit()}
              aria-label={t("limits_add_aria")}
            >
        ...
        <div className="w-full pt-8">
          <h2 className="text-md text-muted-foreground mb-3 font-semibold">
            {t("limits_current_year", { year: currentYear })}
          </h2>
          {currentYearLimits.length ? (
            ...
            <EmptyPlaceholder>
              ...
              <EmptyPlaceholder.Title>
                {t("limits_empty_title", { year: currentYear })}
              </EmptyPlaceholder.Title>
              <EmptyPlaceholder.Description>
                {t("limits_empty_description")}
              </EmptyPlaceholder.Description>
          ...
          {previousYearsLimits.length > 0 && (
            <div className="mt-8">
              <div className="flex items-center justify-center">
                ...
                >
                  {showPreviousYears ? t("limits_hide_previous") : t("limits_show_previous")} {t("limits_previous_years")}
                </Button>
                <Separator className="w-1/3" />
              </div>
              ...
              {showPreviousYears && (
                <div className="mt-8">
                  <h2 className="text-md text-muted-foreground mb-3">{t("limits_previous_years")}</h2>
                  <div className="w-full space-y-4">
