...
const ActivityImportPage = () => {
  ...
  const STEPS = [
    { id: 1, title: t("import.steps.selectAccount") },
    { id: 2, title: t("import.steps.configureMappings") },
    { id: 3, title: t("import.steps.previewImport") },
    { id: 4, title: t("import.steps.importResults") },
  ];
