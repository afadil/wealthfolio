...
VALUES
    ...
    ('VN_MARKET', 'Vietnam Market', 'Vietnam Market Data Provider for stocks on HOSE, HNX, and UPCOM exchanges. Fund from Fmarket Vietnam, and Viet Nam gold price...', 'http://localhost:8765', 2, TRUE, 'vn-market.png', NULL, NULL, NULL);
