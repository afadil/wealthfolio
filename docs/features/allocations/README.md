...
This folder contains documentation for the Wealthfolio Allocation feature, which
enables users to set target percentages for asset classes and individual
holdings, with a live rebalancing advisor.
...
- **[phase-3.md](phase-3.md)** — Complete Phase 3 specification
  ...
  - Portfolio feature implementation (section 1.4 - **complete before Sprint
    2**)
...
- `src/pages/allocation/components/allocation-pie-chart-view.tsx` — Target vs
  Actual section
- `src/pages/allocation/components/holding-target-row.tsx` — Side panel holding
  row
...
- **Jan 2025**: Documentation consolidation — merged 20 files into single master
  phase-3.md
