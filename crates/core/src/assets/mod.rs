...
pub use assets_model::{
    ...
    AssetKind, AssetMetadata, AssetSpec, Country, EnsureAssetsResult, InstrumentId, InstrumentType,
    NewAsset, OptionSpec, ProviderProfile, QuoteCcyResolutionSource, QuoteMode, Sector,
    UpdateAssetProfile,
};
