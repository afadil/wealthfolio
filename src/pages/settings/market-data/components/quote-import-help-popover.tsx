        ...
        <div className="mt-4 grid gap-6 sm:grid-cols-2">
          ...
          <div>
            ...
            <ol className="mt-3 list-inside list-decimal space-y-1 text-sm">
              <li>{t("quote_help_step_1")}</li>
              <li>{t("quote_help_step_2")}</li>
              <li>{t("quote_help_step_3")}</li>
              <li>{t("quote_help_step_4")}</li>
            </ol>
            <div className="mt-4 space-y-3">
              <div className="rounded-md border border-blue-500 bg-blue-50 p-3 dark:border-blue-500/40 dark:bg-blue-900/40">
                <p className="text-sm">
                  <strong className="text-blue-700 dark:text-blue-300">{t("quote_help_tip_title")}</strong> {t("quote_help_tip_text")}
                </p>
              </div>
              ...
              <div className="rounded-md border border-green-500 bg-green-50 p-3 dark:border-green-500/40 dark:bg-green-900/40">
                <p className="text-sm">
                  <strong className="text-green-700 dark:text-green-300">
                    {t("quote_help_required_title")}
                  </strong>{" "}
                  {t("quote_help_required_text")}
                </p>
              </div>
              ...
              <div className="rounded-md border border-purple-500 bg-purple-50 p-3 dark:border-purple-500/40 dark:bg-purple-900/40">
                <p className="text-sm">
                  <strong className="text-purple-700 dark:text-purple-300">
                    {t("quote_help_auto_title")}
                  </strong>{" "}
                  {t("quote_help_auto_text")}
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="space-y-4">
              <div>
                <p className="font-semibold">{t("quote_help_format_title")}</p>
                <pre className="bg-muted mt-2 overflow-x-auto rounded-md p-3 text-xs leading-relaxed select-all">
                  <span className="text-muted-foreground">
                    {t("quote_help_format_comment_1")}
                  </span>
                  <br />
                  <span className="text-muted-foreground">
                    {t("quote_help_format_comment_2")}
                  </span>
                  <br />
              ...
              <div>
                <p className="font-semibold">{t("quote_help_validation_title")}</p>
                <ul className="mt-2 list-inside list-disc space-y-1 text-sm">
                  <li>{t("quote_help_validation_symbol")}</li>
                  <li>{t("quote_help_validation_date")}</li>
                  <li>{t("quote_help_validation_prices")}</li>
                  <li>{t("quote_help_validation_currency")}</li>
                  <li>{t("quote_help_validation_duplicates")}</li>
                </ul>
              </div>

              <div className="rounded-md border border-yellow-500 bg-yellow-50 p-3 dark:border-yellow-500/40 dark:bg-yellow-900/40">
                <p className="text-sm">
                  <strong className="text-yellow-700 dark:text-yellow-300">{t("quote_help_important_title")}</strong>{" "}
                  {t("quote_help_important_text")}
                </p>
              </div>
            </div>
          </div>
