...
const staticNavigation: NavigationProps = {
  primary: [
    ...
    },
    {
      ...
      title: "Insights",
      href: "/insights",
      keywords: ["portfolio", "assets", "positions", "stocks", "performance", "returns", "metrics", "gains", "losses"],
      label: "View Insights",
    },
    {
    ...
    },
    {
      ...
      title: "Cashflow",
      href: "/cashflow",
      keywords: ["cashflow", "spending", "income", "expenses", "earnings", "dividends", "interest", "costs", "payments", "bills"],
      label: "View Cashflow",
    },
    {
      ...
      title: "Activity",
      href: "/activity",
      keywords: ["trades", "transactions", "buy", "sell", "dividends", "investments", "portfolio", "activity", "deposits", "withdrawals"],
      label: "View Activity",
    },
  ],
  secondary: [
