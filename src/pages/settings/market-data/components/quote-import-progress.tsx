    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          {t("quote_import_progress_title")}
        </CardTitle>
        <CardDescription>
          {isImporting ? t("quote_import_progress_importing") : t("quote_import_progress_completed")}
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span>{t("quote_import_progress_label")}</span>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center">
            ...
            <div className="text-muted-foreground text-sm">{t("quote_import_total")}</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600">{successfulRows}</div>
            <div className="text-muted-foreground text-sm">{t("quote_import_successful")}</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-red-600">{failedRows}</div>
            <div className="text-muted-foreground text-sm">{t("quote_import_failed")}</div>
          </div>
        </div>
