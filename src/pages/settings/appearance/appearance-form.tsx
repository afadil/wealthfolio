                ...
                <FormItem>
                  <FormLabel className="[&:has([data-state=checked])>div]:border-primary cursor-pointer">
                    ...
                    <div className="dark items-center rounded-md border-2 border-muted bg-popover p-1 hover:bg-accent hover:text-accent-foreground">
                      <div className="space-y-2 rounded-sm bg-(--flexoki-bg) p-2">
                        <div className="space-y-2 rounded-md bg-(--flexoki-bg-2) p-2 shadow-sm">
                          <div className="h-2 w-[80px] rounded-lg bg-(--flexoki-ui-2)" />
                          <div className="h-2 w-[100px] rounded-lg bg-(--flexoki-ui-2)" />
                        </div>
                        <div className="flex items-center space-x-2 rounded-md bg-(--flexoki-bg-2) p-2 shadow-sm">
                          <div className="h-4 w-4 rounded-full bg-(--flexoki-ui-2)" />
                          <div className="h-2 w-[100px] rounded-lg bg-(--flexoki-ui-2)" />
                        </div>
                        <div className="flex items-center space-x-2 rounded-md bg-(--flexoki-bg-2) p-2 shadow-sm">
                          <div className="h-4 w-4 rounded-full bg-(--flexoki-ui-2)" />
