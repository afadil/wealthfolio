...
pub struct Price {
    ...
    pub pre_market_change_percent: Option<Change>,
    pub pre_market_change: Option<Change>,
    pub pre_market_time: Option<i64>,
    pub pre_market_price: Option<PriceDetail>,
    pub pre_market_source: Option<String>,
    pub post_market_change_percent: Option<Change>,
    pub post_market_change: Option<Change>,
    pub post_market_time: Option<i64>,
    pub post_market_price: Option<PriceDetail>,
    ...
    pub volume_24_hr: Option<Volume>,
    pub volume_all_currencies: Option<Volume>,
    pub circulating_supply: Option<Volume>,
