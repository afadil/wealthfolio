...
WealthVN's shared UI component library built on top of shadcn/ui and Tailwind
CSS.

## Overview

The `@wealthvn/ui` package provides a complete design system for WealthVN
...
- 💰 **WealthVN-specific components** - Financial data display components
...
```tsx
import { Button, Card, CardContent } from "@wealthvn/ui";
...
```tsx
import { AmountDisplay, GainAmount, GainPercent } from "@wealthvn/ui";
...
```tsx
// Import components
import { Button, Card, CardContent, AmountDisplay } from "@wealthvn/ui";

// Import styles (once in your main file)
import "@wealthvn/ui/styles";
...
All standard shadcn/ui components with WealthVN's Flexoki theme applied:
...
3. Customize if needed for WealthVN
...
1. Always import from `@wealthvn/ui` instead of creating custom components
...
This strategy ensures consistent UI/UX across the entire WealthVN ecosystem
