...
VALUES
    ...
    ('OPENFIGI', 'OpenFIGI', 'OpenFIGI provides a mapping service for financial instrument identifiers (FIGI, ISIN, CUSIP, ticker).', 'https://www.openfigi.com/', 12, FALSE, NULL, NULL, NULL, NULL),
    ('METAL_PRICE_API', 'Metal Price API', 'Provides real-time and historical spot prices for precious metals (gold, silver, platinum, palladium).', 'https://metalpriceapi.com/', 13, FALSE, NULL, NULL, NULL, NULL);
