  ...
  return (
    <>
      <div className="space-y-6">
        <SettingsHeader heading={t("goals_title")} text={t("goals_description")}>
          <>
            <Button
              size="icon"
              className="sm:hidden"
              onClick={() => handleAddGoal()}
              aria-label={t("goals_add_aria")}
            >
        ...
        <div className="w-full pt-8">
          {goals?.length ? (
            <>
              <h3 className="p-2 text-xl font-bold">{t("goals_section_title")}</h3>
              ...
              <h3 className="p-2 pt-12 text-xl font-bold">{t("goals_allocations_title")}</h3>
              <h5 className="text-muted-foreground p-2 pt-0 pb-4 text-sm font-light">
                {t("goals_allocations_description")}
              </h5>
              <GoalsAllocations
                goals={goals}
            ...
            <EmptyPlaceholder>
              ...
              <EmptyPlaceholder.Title>{t("goals_empty_title")}</EmptyPlaceholder.Title>
              <EmptyPlaceholder.Description>
                {t("goals_empty_description")}
              </EmptyPlaceholder.Description>
