    ...
    return (
      <div className="flex min-h-0 flex-1 flex-col items-center justify-center p-8">
        ...
        <p className="text-muted-foreground mb-4 text-center">
          Import your first transactions to track spending.
        </p>
        <Link
              ...
              <div className="space-y-4">
                ...
                {topCategories.map(([key, cat], index) => {
                  ...
                  return (
                    <div
                      key={key}
                      className={`hover:bg-muted/50 flex items-center justify-between rounded-md px-2 py-1.5 transition-colors ${isHidden ? "opacity-50" : ""}`}
                    >
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
              {topSubcategories.map(([key, sub], index) => {
                ...
                return (
                  <div
                    key={key}
                    className={`bg-muted/30 hover:bg-muted/50 flex flex-col gap-1 rounded-lg border p-3 transition-colors ${isHidden || isParentHidden ? "opacity-50" : ""}`}
                  >
