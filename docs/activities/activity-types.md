...
Wealthfolio uses a closed set of **14 canonical activity types**. Each activity type has specific semantics affecting:
...
**Required Fields**: `asset`, `quantity`, `unit_price`, `currency`
...
**Required Fields**: `asset`, `quantity` (new total shares)
**Optional Fields**: `metadata.split_ratio` (e.g., "2:1")
...
**Required Fields**: `asset`, `amount`, `currency`
...
**Required Fields**: `amount` or `fee`, `currency`
**Optional Fields**: `asset` (for asset-specific fees)
...
**Required Fields**: `amount`, `currency`
**Optional Fields**: `asset` (for asset-specific taxes)
