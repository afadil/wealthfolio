...
import { FileDropzone } from "@/pages/activity/import/components/file-dropzone";
import { HelpTooltip } from "@/pages/activity/import/components/help-tooltip";
import { ImportAlert } from "@/pages/activity/import/components/import-alert";

interface CashAccountSelectionStepProps {
...
export const CashAccountSelectionStep = ({
  selectedAccount,
  rawData = [],
  csvFile,
  isParsing,
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div>
          <div className="mb-1 flex items-center">
            <h2 className="font-semibold">Select Cash Account</h2>
            <HelpTooltip content="Select the cash account you want to import transactions into" />
          </div>
                ...
                {selectedAccount ? (
                  <>
                    <div className="flex items-center gap-2">
                      <Icons.Wallet className="text-primary h-5 w-5" />
                  ...
                  <>
                    <Icons.Wallet className="text-muted-foreground h-8 w-8" />
        ...
        <div>
          <div className="mb-1 flex items-center">
            ...
            <HelpTooltip content="Upload a CSV file containing your cash transactions. The file should include headers in the first row." />
          </div>
          <div className="h-[120px]">
            <FileDropzone
              file={csvFile}
