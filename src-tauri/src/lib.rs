...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::portfolio::get_spending_summary,
            ...
            commands::activity_rule::create_activity_rule,
            commands::activity_rule::update_activity_rule,
            commands::activity_rule::delete_activity_rule,
            commands::activity_rule::apply_activity_rules,
            commands::activity_rule::bulk_apply_activity_rules,
            commands::activity_rule::test_activity_rule_pattern,
            // Event type commands
